        ...
        <>
            ...
            <div className="back">
                <div className='searchCompo'>
                    ...
                    <input id="title" className='notTouch' name="title" value={searchParamsAlbum.title} type="text" onChange={(e) => { handleSearchChange(e.target.name, e.target.value); e.preventDefault(); }} /><br />
